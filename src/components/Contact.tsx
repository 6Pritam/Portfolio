              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        "https://drive.google.com/file/d/1ESADWJYo6lYYuCiSM7ququyyMFIXnbe5/view?usp=sharing",
                        "_blank"
                      )
                    }
                  >
                  ...
                  <Button
                    ...
                    className="w-full btn-pill justify-start"
                    onClick={() =>
                      window.open("https://topmate.io/pritam_kumar_ghosh/", "_blank")
                    }
                  >
                    ...
                    >
                      {link.isCustomIcon ? (
                        link.customIconType === "hackerrank" ? (
                          <img
                            src="/lovable-uploads/fb3b39a9-3e7a-4198-9665-bef29799399b.png"
                            alt="HackerRank"
                            className="h-4 w-4"
                          />
                        ) : link.customIconType === "leetcode" ? (
                          <img
                            src="/lovable-uploads/4ccf4563-51df-436e-86f8-ead92c6b12a1.png"
                            alt="LeetCode"
                            className="h-4 w-4"
                          />
                        ) : (
